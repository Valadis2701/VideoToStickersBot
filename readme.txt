...
Configure the bot:
  ...
  Edit config.yml and replace the placeholder values with your actual bot token, language and admin IDs.
...
You can customize the bot's behavior and messages in the main.py script.
